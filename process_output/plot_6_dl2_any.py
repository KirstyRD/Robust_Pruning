...
plt.plot(x1,y1, label='dl2 weight 0.0, repeat 50', linewidth=0.5)
plt.plot(x2,y2, label='repeat 100', linewidth=0.5)
plt.plot(x3,y3, label='repeat 200', linewidth=0.5)
plt.plot(x4,y4, label='dl2 weight 0.005, repeat 50', linewidth=0.5)
plt.plot(x5,y5, label='repeat 100', linewidth=0.5)
plt.plot(x6,y6, label='repeat 200', linewidth=0.5)
