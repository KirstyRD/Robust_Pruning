...
plt.plot(x2,y2, label='dl2 weight 0.01', linewidth=0.5)
plt.plot(x3,y3, label='dl2 weight 0.05', linewidth=0.5)
plt.plot(x4,y4, label='dl2 weight 0.1', linewidth=0.5)
plt.plot(x4,y4, label='dl2 weight 0.15', linewidth=0.5)
plt.xlabel('Number of Parameters')
plt.ylabel('Constraint Accuracy')
