...
def train(args, model, device, train_loader, optimizer, epoch, criterion, oracle, test_loader_constr, test_loader_adv, print_iter, starttime, train_writer=None, pruning_engine=None):
...
def main():
    ...
    parser.add_argument('--batch-size-constr', type=int, default=100, help='Number of samples in a batch.')
...
#    print(" ".join(sys.argv))
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if not args.run_test and not args.get_inference_time:
            num_left, new_iter = train(args, model, device, train_loader, optimizer, epoch, criterion, oracle, test_loader_constr, test_loader_adv, print_iter, starttime, train_writer=train_writer, pruning_engine=pruning_engine)
